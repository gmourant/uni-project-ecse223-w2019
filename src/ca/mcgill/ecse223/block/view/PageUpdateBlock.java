...
//                System.out.println(((JSlider) e.getSource()).getValue());
		...
		pointSliders.setBorder(
				BorderFactory.createCompoundBorder(this.getBorder(), BorderFactory.createEmptyBorder(1, 0, 0, 10)));
		...
		updateButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				// call the controller
				try {
					Block223Controller.updateBlock((int) idComboBox.getSelectedItem(), redSlider.getValue(),
							greenSlider.getValue(), blueSlider.getValue(), (int) points.getValue());
				} catch (InvalidInputException e) {
					error = e.getMessage();
