...
public class Block223Controller {
     ...
     * worked properly aka get the game using the name. Author: Georges Mourant
     */
     ...
     * in Block223Application. Author: Georges Mourant
     *
     * @param name name of the game
     * @throws ca.mcgill.ecse223.block.controller.InvalidInputException
     */
    ...
    public static List<TOGame> getDesignableGames() throws InvalidInputException {
        ...
        Admin admin; // holder
        if (Block223Application.getCurrentUser() instanceof Admin) {
            admin = (Admin) Block223Application.getCurrentUser(); // set val
        } else { // throw error
            throw new InvalidInputException("Admin privileges are required to delete a game.");
        }
